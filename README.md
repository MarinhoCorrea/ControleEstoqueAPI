...
API REST para controle de estoque (Spring Boot).
...
- Git (opcional)
- Banco de dados configurado conforme `src/main/resources/application.properties` 
...
```powershell
cd ControleEstoqueAPI\api-version
```
